/**
 * Core message handler — all business logic lives here.
 * No WhatsApp or transport dependencies so this module can be imported
 * by the terminal REPL and e2e tests without pulling in puppeteer or
 * whatsapp-web.js.
 *
